...
nodes in the tree have a parent or predecessor, elimination one case to handle
otherwise.

To make heaps meldable, the allocators in the two heaps muts be all-instance-equal
